          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: Colors.red, // Light green background that complements a light green theme
              ...
              child: ListTile(
                ...
                title: Text(foundItems[index]["title"]!,style: TextStyle(color: Colors.white)),
                subtitle: Text(foundItems[index]["description"]!,style: TextStyle(color: Colors.white)),
                trailing: Text(foundItems[index]["status"]!,style: TextStyle(color: Colors.white)),
                onTap: () {
